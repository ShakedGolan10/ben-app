...
export default function HisWayTeaser() {
    ...
    <div className={`bg-bgc-white h-screen flex flex-col justify-around items-center relative max-h-70vh mobile:py-8`}>
        <section className='images-container absolute w-full h-full flex flex-col justify-between'>`
            <Image src={birdsPic} alt='birds in the background' id='up-photo' className=' max-w-[50%] h-full self-end object-cover object-center transform translate-y-[-5vh] '/>
            <Image src={birdsPic} alt='birds in the background' id='bottom-photo' className=' max-w-[50%] h-full object-cover '/>
        </section>
