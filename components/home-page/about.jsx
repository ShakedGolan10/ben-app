...
export default function About() {
  return (
    <section className='about-section bg-white relative py-8vh'>
        ...
        <p dangerouslySetInnerHTML={{ __html: aboutBen }} className=' text-headline-font-color font-medium max-w-35vw max-h-80vh self-center text-medium mobile:text-sm mobile:max-w-77vw overflow-auto' />
        
        {/* </p> */}
        <Image src={benTypoImg} alt='ben handwrite sentance' className='bottom-33vh right-37vw max-h-25vh max-w-8vw self-center mobile:max-w-77vw object-contain'/>
        <Image src={aboutImg} alt='image of ben' className='rounded-r-md h-66vh max-w-30vw object-cover self-center mobile:max-w-77vw' />
        </div>
